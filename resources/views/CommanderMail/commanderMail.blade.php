...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #1b262c; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;"><strong><span style="font-size: 26px; line-height: 36.4px;">Bonjour</span></strong></p>
  </div>
...
<table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
  ...
  <div style="color: #1b262c; line-height: 140%; text-align: center; word-wrap: break-word;">
    <p style="font-size: 14px; line-height: 140%;">Notre pharmacie a besoin d'une quantité du stock de médicament suivant :</p>
    <p style="font-size: 14px; line-height: 140%;">Médicament : {{$medicament}}</p>
    <p style="font-size: 14px; line-height: 140%;">Quantité : {{$qte}}</p>
    <p style="font-size: 14px; line-height: 140%;">Merci de vérifier cette commande le plus temps possible.</p>
  </div>
